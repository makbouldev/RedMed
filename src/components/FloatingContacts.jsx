...
export default function FloatingContacts({ onOpenPrinting }) {
  return (
    <>
      {/* Floating print button on the bottom-left */}
      {onOpenPrinting && (
        <button 
          className="floating-print-btn" 
          onClick={onOpenPrinting}
          aria-label="Demander une impression personnalisée"
          title="Impression & Broderie"
        >
          <Printer size={16} />
          <span>Impression &amp; Broderie</span>
        </button>
      )}

      {/* Floating social links on the bottom-right */}
      <div className="floating-contacts">
        ...
        <a 
          href="https://www.instagram.com/red_med004/" 
          target="_blank" 
          rel="noopener noreferrer" 
